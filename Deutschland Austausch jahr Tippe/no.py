...
class No(webapp.RequestHandler):
  def get(self):
...
''')
    ...
    self.response.out.write(''' <font size="5"><p>you have selected a Tip that is not yours so
                              you can not delete it</p>''')
...
application = webapp.WSGIApplication([('/no', No)], debug=True)
